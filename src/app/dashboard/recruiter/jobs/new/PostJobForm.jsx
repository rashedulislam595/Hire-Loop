                ...
                <div className="px-8 py-6 border-b border-zinc-800 flex items-center justify-between bg-[#1c1c1f]">
                    <div>
                        ...
                        <p className="text-xs text-zinc-400 mt-0.5">
                            Deploy a public job document linked to workspace: <span className="text-zinc-200 font-medium">{company.name}</span>.
                        </p>
                    </div>
                        ...
                        <div className="space-y-4 pt-2">
                            ...
                            <div className="flex items-center gap-4 p-4 bg-[#1f1f23] rounded-lg border border-zinc-800/80">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-2">
                                        <p className="text-white text-sm font-semibold leading-none">{company.name}</p>
