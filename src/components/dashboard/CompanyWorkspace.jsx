...
export default function CompanyWorkspace({ recruiter = null, recruiterCompany }) {
    // --- STATES ---
    const [company, setCompany] = useState(recruiterCompany); // null মানে কোনো কোম্পানি রেজিস্টার্ড নেই
